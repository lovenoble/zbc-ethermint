...
func (k Keeper) TraceTx(c context.Context, req *types.QueryTraceTxRequest) (*types.QueryTraceTxResponse, error) {
	...
	for i, tx := range req.Predecessors {
		...
		msg := core.Message{
			...
			Value:             ethTx.Value(),
			GasLimit:          ethTx.Gas(),
			GasPrice:          new(big.Int).Set(ethTx.GasPrice()),
		...
		msg.GasPrice = math.BigMin(msg.GasPrice.Add(msg.GasTipCap, cfg.BaseFee), msg.GasFeeCap)
		msg.From, err = ethtypes.Sender(signer, ethTx)
		if err != nil {
			continue
		}
...
func (k *Keeper) traceTx(
	...
	msg.GasPrice = math.BigMin(msg.GasPrice.Add(msg.GasTipCap, cfg.BaseFee), msg.GasFeeCap)
	msg.From, err = ethtypes.Sender(signer, tx)
	if err != nil {
