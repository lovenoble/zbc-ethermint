...
func VerifyFee(
	...
	denom string,
	baseFee *big.Int,
	homestead, istanbul, shangai, isCheckTx bool,
) (sdk.Coins, error) {
	...
	intrinsicGas, err := core.IntrinsicGas(txData.GetData(), accessList, isContractCreation, homestead, istanbul, shangai)
	if err != nil {
		return nil, errorsmod.Wrapf(
			err,
			"failed to retrieve intrinsic gas, contract creation = %t; homestead = %t, eip2028 = %t, eip3860 = %t",
			isContractCreation, homestead, istanbul, shangai,
		)
	}
