...
func (cc ChainConfig) EthereumConfig(chainID *big.Int) *params.ChainConfig {
	var shanghaiTime *uint64 = nil
	if cc.ShanghaiBlock != nil {
		shanghaiTimeValue := getBlockValue(cc.ShanghaiBlock).Uint64()
		shanghaiTime = &shanghaiTimeValue
	}
	var cancunTime *uint64 = nil
	if cc.CancunBlock != nil {
		cancunTimeValue := getBlockValue(cc.CancunBlock).Uint64()
		cancunTime = &cancunTimeValue
	}
