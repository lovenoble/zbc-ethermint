...
func (suite *AnteTestSuite) SetupTest() {
	...
	suite.ctx = suite.app.BaseApp.NewContext(checkTx, tmproto.Header{Height: 2, ChainID: testutil.TestnetChainID, Time: time.Now().UTC()})
...
func (suite *AnteTestSuite) createBaseTxBuilder(msg sdk.Msg, gas uint64) client.TxBuilder {
	...
	txBuilder.SetFeeAmount(sdk.NewCoins(
		sdk.NewCoin("ainco", sdk.NewInt(10000)),
	))
